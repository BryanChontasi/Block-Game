...
function finishGame() {
  ...
  var scrObject ={}
  scrObject.name = document.getElementById("username1").value;
  scrObject.Score = document.getElementById("score").value;  
  
  localStorage[scrObject.username] = JSON.stringify(scrObject);
  document.getElementById("result1").innerHTML =  scrObject.name + " Score: " + scrObject.Score;
}
...
function pasteNewCell() {
  ...
  if (!countFree){
    finishGame();
    return alert("you loss the game");
  }
